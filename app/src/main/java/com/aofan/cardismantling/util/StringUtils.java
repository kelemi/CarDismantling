...
public final class StringUtils {
    ...
    public static boolean isValidConfirmPwd(String confirmPwd,
            String pwd) {
        if (isEmpty(pwd)) {
    ...
    public static String hexToDec(String hex) {
        ...
        for (int i = 0; i < sources.length; i++) {
            int digit = HEX_DIGITS.indexOf(Character
                    .toUpperCase(sources[i]));
     ...
     * @param c 字符
     * @param n 第几�?
     * @return 如果没有找到c,返回-1,如果c的数�?�?够n返回-1
     */
    ...
    /**
     * 用字符c把字符串src分割�?字符串数�?如果字符c�?�?�有逃�?符esc,�?进行分割
     * 
     * @param src 字符�?
     * @param c 分隔�?
     * @param esc 逃�?�?
    ...
    /**
     * 用字符c把字符串src分割�?字符串数�?�?�分割第�?���?��?�的�?进行分割,如果字符c�?�?�有逃�?符esc,�?进行分割
     * 
     * @param src 字符�?
     * @param c 分隔�?
     * @param esc 逃�?�?
    ...
    public static String decodeUTF8String(String src) {
        ...
        for (int i = 0; i < sources.length; i++) {
            if (sources[i] == '\\' && i < sources.length - 5
                    && sources[i + 1] == 'u') {
                String utf8 = "" + sources[i++] + sources[i++]
