...
public class ActivityAddNewPaiGongDanForCuChai extends BaseActivity implements AddPaiGongDanContract.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_new_paigongdan_for_cuchai);
    ...
    public void initView() {
        ...
        /*RxView.clicks(tvChooseLingjian)
                ...
                .subscribe(new Action1<Void>() {
                    @Override
                    public void call(Void aVoid) {
                        Intent toChooseLingJian = new Intent(ActivityAddNewPaiGongDanForCuChai.this, ActivityChooseChaiJieLingJianNew.class);
        ...
        RxView.clicks(tvChooseChaijieWorker)
                ...
                .subscribe(new Action1<Void>() {
                    @Override
                    public void call(Void aVoid) {
                        Intent toChooseWorker = new Intent(ActivityAddNewPaiGongDanForCuChai.this, ActivityChooseChaiJieWorker.class);
    ...
    public void addPaiGongDan() {
        mPresenter.addPaiGongDan("粗拆",(String) CommonUtil.getShareValue(ShareKey.SHARE_KEY_USER_ID, ""),
