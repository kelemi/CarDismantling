...
import com.aofan.cardismantling.adapter.list.ListAdapterForPaiGongDan;
...
import com.aofan.cardismantling.mvp.carwaittochaijie.addnewpaigongdan.ActivityAddNewPaiGongDan;
 ...
 * 一辆车子的派工单情况
 * 如果没有派工完成，则可以继续派工，
 * 如果派工完成了,则就不显示继续派工的操作按钮了
 * Created by Administrator on 2016/11/21.
 */

public class ActivityOneCarChaiJiePaiGongDanList extends BaseActivity implements PullToRefreshBase.OnRefreshListener2, PaiGongDanListContract.View {
...
*/
    ...
    ListAdapterForPaiGongDan mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_car_chaijie_paigongdanlist_for_jingchai);
        initTitleWithRightTvOrIv(null, null, "派工单详情", true, null, R.drawable.ico_add_white);
        initData();
        assignView();
        initView();
    ...
    public void assignView() {
       ...
       /* layoutCarCompleteChaijie = (LinearLayout) findViewById(R.id.layout_car_complete_chaijie);
        tvCarCompleteChaijie = (TextView) findViewById(R.id.tv_car_complete_chaijie);*/
    ...
    public void initView() {
        ...
        mAdapter = new ListAdapterForPaiGongDan(mPaiGongDanList, this);
        ...
        RxView.clicks(ivRight)
                ...
                .subscribe(new Action1<Void>() {
                    @Override
                    public void call(Void aVoid) {
                        if (mCarChaiJieType.equals(Config.TYPE_STR_OF_CHAIJIEWAY_JINGCHAI))
                        {
                            Intent toAddPaiGongDan = new Intent(ActivityOneCarChaiJiePaiGongDanList.this, ActivityAddNewPaiGongDan.class);
                            toAddPaiGongDan.putExtra(IntentKey.INTENT_KEY_CAR_INFO_OF_PAIGONGDAN, mCarOfPaiGongDan);
                            toAddPaiGongDan.putExtra(IntentKey.INTENT_KEY_CAR_CHAIJIE_TYPE, mCarChaiJieType);

                            startActivity(toAddPaiGongDan);

                        }/*else if (mCarChaiJieType.equals(Config.TYPE_STR_OF_CHAIJIEWAY_CUCHAI))
                        {
                            Intent toAddPaiGongDan = new Intent(ActivityOneCarChaiJiePaiGongDanList.this, ActivityAddNewPaiGongDanForCuChai.class);
                            toAddPaiGongDan.putExtra(IntentKey.INTENT_KEY_CAR_INFO_OF_PAIGONGDAN, mCarOfPaiGongDan);
                            startActivity(toAddPaiGongDan);
                        }*/
    ...
    public void showCarPaiGongDanList(List<PaiGongDanitem> paiGongDanList) {
        ...
        if (mCarPaiGongState.equals(Config.TYPE_OF_PAIGONG_STATE_HAS_PAIGONG) || mPaiGongDanList.size() == 0) {
            ...
            //如果是精拆，且已经有派工单，则显示完成派工按钮
            if (mCarChaiJieType.equals(Config.TYPE_STR_OF_CHAIJIEWAY_JINGCHAI))
            {
                tvFinishedPaidan.setVisibility(View.VISIBLE);
            //如果是粗拆，且已有派工单，则不显示完成派工按钮，粗拆只派工一次
            }else if (mCarChaiJieType.equals(Config.TYPE_STR_OF_CHAIJIEWAY_CUCHAI)){
                tvFinishedPaidan.setVisibility(View.VISIBLE);
            }
    ...
    public void submitCarFinishChaiJie() {
        mPresenter.submitCarFinishChaiJie((String) CommonUtil.getShareValue(ShareKey.SHARE_KEY_USER_ID, ""),
                mCarOfPaiGongDan.getBaseid(),Config.TYPE_STR_OF_CHAIJIEWAY_JINGCHAI);
    }
