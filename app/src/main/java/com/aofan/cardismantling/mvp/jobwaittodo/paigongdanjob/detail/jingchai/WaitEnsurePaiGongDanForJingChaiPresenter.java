...
public class WaitEnsurePaiGongDanForJingChaiPresenter implements WaitEnsurePaiGongDanForJingChaiContract.Presenter {


    @NonNull
    WaitEnsurePaiGongDanForJingChaiContract.View mEnsurePaiGongDanView;
    ...
    public WaitEnsurePaiGongDanForJingChaiPresenter(@NonNull WaitEnsurePaiGongDanForJingChaiContract.View mEnsurePaiGongDanView, @NonNull BaseSchedulerProvider mSchedulerProvider, @NonNull HttpService mHttpService) {
