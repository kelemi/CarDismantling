 ...
 */
public class NewActionSheet extends Fragment implements View.OnClickListener {
    ...
    public void show(final FragmentManager manager, final String tag) {
        ...
        new Handler().post(new Runnable() {
            public void run() {
                ...
                ft.add(NewActionSheet.this, tag);
    ...
    private View createView() {
        ...
        mBg.setId(NewActionSheet.BG_VIEW_ID);
    ...
    private void createItems() {
        ...
        bt.setTextSize(TypedValue.COMPLEX_UNIT_PX, mAttrs.actionSheetTextSize);
        bt.setId(NewActionSheet.CANCEL_BUTTON_ID);
    ...
    private Attributes readAttribute() {
        ...
        TypedArray a = getActivity().getTheme().obtainStyledAttributes(null,
                R.styleable.NewActionSheet, R.attr.actionSheetStyle, 0);
        Drawable background = a
                .getDrawable(R.styleable.NewActionSheet_actionSheetBackground);
        if (background != null) {
            attrs.background = background;
        }
        Drawable cancelButtonBackground = a
                .getDrawable(R.styleable.NewActionSheet_cancelButtonBackground);
        if (cancelButtonBackground != null) {
            attrs.cancelButtonBackground = cancelButtonBackground;
        }
        Drawable otherButtonTopBackground = a
                .getDrawable(R.styleable.NewActionSheet_otherButtonTopBackground);
        ...
        Drawable otherButtonMiddleBackground = a
                .getDrawable(R.styleable.NewActionSheet_otherButtonMiddleBackground);
        ...
        Drawable otherButtonBottomBackground = a
                .getDrawable(R.styleable.NewActionSheet_otherButtonBottomBackground);
        ...
        Drawable otherButtonSingleBackground = a
                .getDrawable(R.styleable.NewActionSheet_otherButtonSingleBackground);
        ...
        attrs.cancelButtonTextColor = a.getColor(
                R.styleable.NewActionSheet_cancelButtonTextColor,
                attrs.cancelButtonTextColor);
        attrs.otherButtonTextColor = a.getColor(
                R.styleable.NewActionSheet_otherButtonTextColor,
                attrs.otherButtonTextColor);
        attrs.padding = (int) a.getDimension(
                R.styleable.NewActionSheet_actionSheetPadding, attrs.padding);
        attrs.otherButtonSpacing = (int) a.getDimension(
                R.styleable.NewActionSheet_otherButtonSpacing,
                attrs.otherButtonSpacing);
        attrs.cancelButtonMarginTop = (int) a.getDimension(
                R.styleable.NewActionSheet_cancelButtonMarginTop,
                attrs.cancelButtonMarginTop);
        attrs.actionSheetTextSize = a.getDimensionPixelSize(R.styleable.NewActionSheet_actionSheetTextSize, (int) attrs.actionSheetTextSize);
    ...
    public void onClick(View v) {
        if (v.getId() == NewActionSheet.BG_VIEW_ID && !getCancelableOnTouchOutside()) {
            return;
        }
        dismiss();
        if (v.getId() != NewActionSheet.CANCEL_BUTTON_ID && v.getId() != NewActionSheet.BG_VIEW_ID) {
            if (mListener != null) {
    ...
    public static class Builder {
        ...
        public NewActionSheet show() {
            NewActionSheet actionSheet = (NewActionSheet) Fragment.instantiate(
                    mContext, NewActionSheet.class.getName(), prepareArguments());
    ...
    public static interface ActionSheetListener {
        ...
        void onDismiss(NewActionSheet actionSheet, boolean isCancel);

        void onOtherButtonClick(NewActionSheet actionSheet, int index);
    }
}
