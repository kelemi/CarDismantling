...
public class FunctionConfig implements Cloneable{
    ...
    private ArrayList<PhotoInfo> selectedPhotoList;
    ...
    private FunctionConfig(final Builder builder) {
        ...
        this.selectedPhotoList = builder.selectedPhotoList;
    }
    ...
    public static class Builder {
       ...
       /* public ArrayList<PhotoInfo> getSelectedPhotoList() {
        ...
        public void setSelectedPhotoList(ArrayList<PhotoInfo> selectedPhotoList) {
        ...
        public Builder setSelected(Collection<PhotoInfo> selectedList) {
            if ( selectedList != null ) {
                ...
                selectedPhotoList = (ArrayList<PhotoInfo>) selectedList;
